<%-- 
    Document   : addgrup
    Created on : 19/06/2015, 08:14:38 AM
    Author     : Arturo Rguez C
--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                <div class="btn-group">
                                    ...
                                    <a href="#" data-toggle="dropdown" class="btn btn-default dropdown-toggle">
                                        <span class="dropdown-label">Seleccione un grado</span>&nbsp;&nbsp;&nbsp;<span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu dropdown-select">
                                        <li><input type="radio" name="grado" value="1"><a href="#">1</a></li>
                                        <li><input type="radio" name="grado" value="2"><a href="#">2</a></li>
                                        <li><input type="radio" name="grado" value="3"><a href="#">3</a></li>
                                        <li><input type="radio" name="grado" value="4"><a href="#">4</a></li>
                                        <li><input type="radio" name="grado" value="5"><a href="#">5</a></li>
                                        <li><input type="radio" name="grado" value="6"><a href="#">6</a></li>
                                        <li><input type="radio" name="grado" value="7"><a href="#">7</a></li>
                                        <li><input type="radio" name="grado" value="8"><a href="#">8</a></li>
                                        <li><input type="radio" name="grado" value="9"><a href="#">9</a></li>
                                        <li><input type="radio" name="grado" value="10"><a href="#">10</a></li>
                                        <li><input type="radio" name="grado" value="11"><a href="#">11</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-select">
                                        <li><input type="radio" name="grupo" value="A"><a href="#">A</a></li>
                                        <li><input type="radio" name="grupo" value="B"><a href="#">B</a></li>
                                        <li><input type="radio" name="grupo" value="C"><a href="#">C</a></li>
                                        <li><input type="radio" name="grupo" value="D"><a href="#">D</a></li>
                                        <li><input type="radio" name="grupo" value="E"><a href="#">E</a></li>
                                        <li><input type="radio" name="grupo" value="F"><a href="#">F</a></li>
                                        <li><input type="radio" name="grupo" value="G"><a href="#">G</a></li>
                                        <li><input type="radio" name="grupo" value="H"><a href="#">H</a></li>
                                        <li><input type="radio" name="grupo" value="I"><a href="#">I</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                <div class="btn-group">
                                    ...
                                    <div class="clearfix"></div>
                                    <a href="#" data-toggle="dropdown" class="btn btn-default dropdown-toggle">
                                        <span class="dropdown-label">Seleccione una carrera</span>&nbsp;&nbsp;&nbsp;<span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu dropdown-select">
                                        <li><input type="radio" name="idcarrera" value="1"><a href="#">T. S. U. Tecnologias de la Información y Comunicación</a></li>
                                        <li><input type="radio" name="idcarrera" value="2"><a href="#">Ing. Tecnologias de la Información y Comunicación</a></li>
                                        <li><input type="radio" name="idcarrera" value="4"><a href="#">T. S. U. Gastronomia</a></li>
                                        <li><input type="radio" name="idcarrera" value="3"><a href="#">Lic. Gastronomia</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                <div class="btn-group">
                                    ...
                                    <div class="clearfix"></div>
                                    <a href="#" data-toggle="dropdown" class="btn btn-default dropdown-toggle">
                                        <span class="dropdown-label">Seleccione un turno</span>&nbsp;&nbsp;&nbsp;<span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu dropdown-select">
                                        <li><input type="radio" name="turno" value="Matutino"><a href="#">Matutino</a></li>
                                        <li><input type="radio" name="turno" value="Vespertino"><a href="#">Vespertino</a></li>
                                        <li><input type="radio" name="turno" value="Mixto"><a href="#">Mixto</a></li>
